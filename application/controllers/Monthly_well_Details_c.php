<?php 
    ...
    class Monthly_well_Details_c extends MY_Controller
    {
        ...
        public function index()
        {
            ...
            $d['v'] = "monthly_well_Details_view";
            $this->load->view('templates',$d); 
        }

        public function get_area_assetwise_monthlywell_report()
        {
            $api = 'Report/Asset_Areawise_monthly_WellDetails_report';
            $method = 'POST';
