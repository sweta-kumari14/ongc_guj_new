<?php
class Device_Replacementdata_model extends CI_Model
{
	...
	{
		return $this->db->select("count(id) as total,device_name,date_of_installation")->from('tbl_site_device_installation')->where(['imei_no'=>$imei_no,'status'=>1])->get()->result_array();
	...
	public function UpdateOld_Device_Allotstatus($data,$where)
	{
