...
class List_model extends CI_Model
{
    ...
    public function Flowing_Well($company_id, $assets_id, $area_id, $user_id, $well_id,$site_id)
    {
    ...
    public function Non_Flowing_Well($company_id, $assets_id, $area_id, $user_id, $well_id,$site_id)
    {
        ...
        return $this->db->select("di.well_id, wmm.well_name, di.Log_Date_Time , di.CHP, di.THP, di.ABP, di.FLT,di.Battery_Voltage,am.area_name, wm.well_site_name, wt.well_type_name, di.site_id, di.well_type, di.area_id, di.device_name, di.imei_no")
            ->get()
            ->result_array();
    }
    ...
    public function NonFunctional_RTMS_List($company_id, $assets_id, $area_id, $site_id, $user_id)
    {
        ...
        return $this->db->select("sd.*, wm.well_name, am.area_name, sm.well_site_name, wt.well_type_name")
            ...
            ->where(['sd.status' => 1, 'sd.well_setup_status' => 1, 'ad.status' => 1, 'sd.well_status' => 0])
            ->group_by('sd.id')
