                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h4 class="header-title mb-4">Running Well List</h4>
                                </div>
...
<script type="text/javascript">
    ...
    running_well_details();
    function running_well_details()
    {   
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>Dashboard_c/running_well_ajax',
            method: 'POST',
                        ...
                        $.each(response.data, function (i, v) {
                            ...
                            $("#table_body").append('<tr>' +
                               ...
                               '<td><a href="<?php echo base_url('Dashboard_c/get_single_well_detail_dashboard/'); ?>' + v.well_id + '" style="color: green;">' + v.well_name + '</a></td>'+
                                ...
                                '<td><button class="btn btn-sm btn-rounded btn-pill" style="color:white;background-color:#74B72E;white-space: nowrap;">ON</button></td>' +
