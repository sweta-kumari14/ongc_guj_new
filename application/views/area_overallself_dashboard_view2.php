<div class="page-wrapper">
    ...
    <!-- Page Header -->
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Running Well</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('Selfflow_c');?>">Dashboard</a></li>
                            <li class="breadcrumb-item ">Flowing Well</li>
                    ...
                    <div class="table-responsive" style="max-height: 500px; overflow-y: auto; overflow-x: auto;">
                        <table class="table table-bordered table-hover m-0" id="data-table">
                            <thead class="thead-dark">
                                <tr>
                                    <th class="sortable" data-index="0" onclick="sortMIS(0)">
                                        <div class="sort-header">S.No <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="1" onclick="sortMIS(1)">
                                        <div class="sort-header">Area <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    
                                    
                                    <th class="sortable" data-index="4" onclick="sortMIS(4)">
                                        <div class="sort-header">Well <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="6" onclick="sortMIS(6)">
                                        <div class="sort-header">Last Updated Date Time <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="7" onclick="sortMIS(7)">
                                        <div class="sort-header">Imei No <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="8" onclick="sortMIS(8)">
                                        <div class="sort-header">THP (kgf/cm²) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="9" onclick="sortMIS(9)">
                                        <div class="sort-header">CHP (kgf/cm²) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    <th class="sortable" data-index="10" onclick="sortMIS(10)">
                                        <div class="sort-header">ABP (kgf/cm²) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    
                                    <th class="sortable" data-index="12" onclick="sortMIS(12)">
                                        <div class="sort-header">FLT (°C) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                    
                                    <th class="sortable" data-index="14" onclick="sortMIS(14)">
                                        <div class="sort-header">Battery (v) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></div>
                                    </th>
                                </tr>
                            </thead>
...
$(document).ready(function () {
    ...
    get_flowing_list(); // Initial call
});
let link_url = '<?php echo base_url();?>';
function get_flowing_list() {
    ...
    Object.keys(areaMap).forEach(areaName => {
        ...
        areaGroups.forEach(group => {
            ...
            group.records.forEach((v, i) => {
                ...
                const link = `${link_url}Selfflow_c/SingleWellDashboard/${v.well_id}/${v.site_id}/${v.area_id}`;
                let battery_value = v.Battery_Voltage;
                console.log(battery_value,'battery');
                    var currentTime = new Date();
                        var timeDifference = (currentTime - lastUpdatedTime) / (1000 * 60);
                        var rtms_status = '';
                        let timeLimit = '900';
                        if (timeDifference < timeLimit) 
                        {
                            if (flag_status == 1) {
                                rtms_status = '<span style="height: 18px; width: 18px; background-color: #28a745; border-radius: 50%; display: inline-block;" title="Flowing"></span>';
                            } else if (flag_status == 2) {
                                rtms_status = '<span style="height: 18px; width: 18px; background-color: #ECA869; border-radius: 50%; display: inline-block;" title="Non Flowing"></span>';
                            }
                        } else {
                           if (battery_value < 6 && battery_value !== null && battery_value !== '') 

                            {
                                rtms_status = '<span style="height: 18px; width: 18px; background-color: #82A0D8; border-radius: 50%; display: inline-block;" title="Battery Issue"></span>';
                            }else{

                                rtms_status = '<span style="height: 18px; width: 18px; background-color: #dc3545; border-radius: 50%; display: inline-block;" title="Offline"></span>';
...
<script type="text/javascript">
async function exportFlowing_wellReportToExcel() {
    ...
    const sheet = workbook.addWorksheet('Flowing Well Report');
    ...
    sheet.getCell('A2').value = `Flowing Well List`;
