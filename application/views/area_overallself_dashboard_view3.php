        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-3">
                    <div class="col">
                        <h4 class="header-title mb-0">Temporary Well List</h4>
                    </div>
...
<script type="text/javascript">
    ...
    async function export_report() {
        ...
        sheet.getCell('A2').value = `Temporary Well List Report`;
        ...
        link.download = "Temporary_Well_Report.xlsx";
