                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h5 class="card-title fs-20 mb-0">Not Flowing Wells</h5>
                            </div>
...
<script type="text/javascript">
     get_non_flowing_well_list();
    function get_non_flowing_well_list() {
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>Overall_list_selfflow_c/non_flowing_well_ajax',
        method: 'POST',
    ...
    try {
        ...
        $('#table_data').html('<tr><td colspan="26" class="text-danger">Invalid response from server</td></tr>');
        return;
    }
    ...
    if (response && response.response_code == 200) {
        ...
        if (response.data.length > 0) {
            ...
            $('#table_data').html('<tr><td class="text-danger text-center" colspan="26">No Record Found !!</td></tr>');
        }
    } else {
        $('#table_data').html('<tr><td class="text-danger text-center" colspan="26">Invalid response format</td></tr>');
    }
}
