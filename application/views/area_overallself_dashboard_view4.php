                        ...
                        <table class="table table-bordered table-hover m-0" id="data-table">
                            <thead >
                               <tr>
                                    ...
                                    <th class="sortable" data-index="6" onclick="sortMIS(6)">Last Updated Date Time <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>
                                    <th class="sortable" data-index="7" onclick="sortMIS(7)">Imei No <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>

                                    <th class="sortable" data-index="8" onclick="sortMIS(8)">FTHP (kgf/cm²)<span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>

                                    <th class="sortable" data-index="9" onclick="sortMIS(9)">CHP (kgf/cm²)<span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>

                                    <th class="sortable" data-index="10" onclick="sortMIS(10)">ABP (kgf/cm²)<span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>

                                   
                                    <th class="sortable" data-index="12" onclick="sortMIS(12)">FLT (°C)<span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>
                                    
                                    <th class="sortable" data-index="14" onclick="sortMIS(14)">Battery (v) <span class="arrow"><span class="up">▲</span><span class="down">▼</span></span></th>
                                </tr>
                            </thead>
...
$(document).ready(function () {
    ...
    get_battery_issue_well(); // Initial call
});
let link_url = '<?php echo base_url();?>';
function get_battery_issue_well() {
    ...
    $.ajax({
        url: base_url + 'Overall_list_selfflow_c/battery_issue_wells_data_ajax',
        method: 'POST',
