        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-3">
                    <div class="col">
                        <h4 class="header-title mb-0">Offline Well List</h4>
                    </div>
...
<script type="text/javascript">
    ...
    async function export_report() {
        ...
        sheet.getCell('A2').value = `Offline Well List Report`;
        ...
        link.download = "Offline_Well_Report.xlsx";
