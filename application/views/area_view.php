                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
								        ...
								        <div class="col-auto float-end ms-auto">
								             <a href="<?php echo base_url('Area_c/add_area_page'); ?>">
													...
													?>
														<tr>
															...
															<td>
									                          ...
									                          <a href="<?php echo base_url().'Area_c/edit_area/'.$value['id'];  ?>"><i class="fas fa-pencil-alt" style="font-size:20px;color:green;"></i>
									                          </a>
									                                                
									                          <a id="<?php echo $value['id']; ?>" onclick="delete_area(this.id);">
      ...
      swal({
         ...
         .then((willDelete) => {
           if (willDelete) {
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo base_url(); ?>Area_c/delete_area',
                data:{id: id},
                success:function(res)
                {
                    ...
                    if(res.response_code==200)
                    {
                      ...
                      setTimeout(()=>{window.location.href="<?php echo base_url(); ?>Area_c"},200)
                   }else
                   {
