					...
					<div class="card-header" style="background :linear-gradient(to left, #E29990 , #5D6D7E );border-radius: 5px;">
						...
						<div class="row">
                            ...
                            <div class="form-group col-md-4 mt-2" style="display: none;">
                                    <h5><b>Area Name</b></h5>
                                    <select name="site_id" id="site_id" class="form-control select2" onchange="get_complaints_data();">
                                       <?php
        ...
        <div class="col-md-12">
         ...
         <div class="col-md-4">
           <div class="offcanvas offcanvas-end" tabindex="-1" id="EditComplaint" aria-labelledby="offcanvasRightLabel">
              <div class="offcanvas-header">
                    <h3 id="offcanvasRightLabel"><b>Edit Complaint</b></h3>
...
function get_complaints_data()
{
    ...
    $.ajax({
        ...
        method:'POST',
        data:{company_id:company_id,from_date:from_date,to_date:to_date,site_id:site_id,ticket_id:ticket_id,complaint_status:complaint_status,sort_by:sort_by},
        success:function(res)
        {
                        ...
                        $.each(response.data,function(i,v){
                         ...
                         if(compaint_type == 0)
                            ...
                            $("#table_data").append('<tr>'+
                                    '<td>'+(i+1)+'</td>'+
                                    '<td>'+
                                       '<a id="' +v.id + '"  data-bs-toggle="offcanvas" data-bs-target="#EditComplaint" aria-controls="offcanvasRight"  onclick="EditComplaint(this.id);"><i class="fas fa-edit" style="color: #28B463; margin-right: 10px; font-size: 15px; cursor: pointer;"></i></a>'+
                                    '</td>'+
...
<script type="text/javascript">
    function EditComplaint(id)
    {
        ...
        $.ajax({
        url:"<?php echo base_url();?>Technical_compalint_c/edit_complaints",
        method:"POST",
        data:{id: id},
