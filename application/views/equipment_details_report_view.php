				...
				<div class="row">
					<div class="col-sm-12">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item ">Equipment Details</li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                        	    <div class="col">
		                            <h4 class="header-title mb-4">Equipment Report</h4>
		                        </div>
							...
							<div class="row">
								...
								<div class="form-group col-md-4 mt-2">
									<h5><b>From Date</b></h5>
									<input type="date" name="from_date" id="from_date" class="form-control" onchange="get_equipment_details_data();">
								</div>

								<div class="form-group col-md-4 mt-2">
									<h5><b>To Date</b></h5>
									<input type="date" name="to_date" id="to_date" class="form-control" onchange="get_equipment_details_data();">
								</div>
                             ...
                             <div class="table-responsive">
								<table class="table table-striped custom-table mb-0 datatable" id="data-table">
									<tr>
											<th colspan="15" class="text-uppercase" style="font-size: 20px;font-weight: bolder;">IOT Based Real Time Well Monitoring System ONGC,CBM Asset Bokaro</th>
										</tr>
										<tr>
											<th colspan="15" class="text-uppercase" style="font-size: 15px;font-weight: bolder;">Equipment Reports as on <?php echo date('d-m-Y h:i:s a') ?></th>
										</tr>
										<tr>
                     ...
                     if(response.data.length > 0)
                     {
                        $.each(response.data,function(i,v){
                            ...
                            $("#table_data").append('<tr>'+
                                    ...
                                    '<td>'+v.dh_pump_make+'</td>'+
                                    '<td>'+v.dh_pump_capacity+'</td>'+
