                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                    	<div class="col">
					                       <h4 class="header-title mb-4">FEEDER List</h4>
					                    </div>
								        <div class="col-auto float-end ms-auto">
								             <a href="<?php echo base_url('Feeder_master_c/add_feeder_page'); ?>">
													...
													?>
														<tr>
															...
															<td>
									                          ...
									                          <a href="<?php echo base_url().'Feeder_master_c/edit_feeder/'.$value['id'];  ?>"><i class="fas fa-pencil-alt" style="font-size:20px;color:green;"></i>
									                          </a>
									                                                
									                          <a id="<?php echo $value['id']; ?>" onclick="delete_feeder(this.id);">
      ...
      swal({
         ...
         .then((willDelete) => {
           if (willDelete) {
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo base_url(); ?>Feeder_master_c/delete_feeder',
                data:{id: id},
                success:function(res)
                {
                    ...
                    if(res.response_code==200)
                    {
                      ...
                      setTimeout(()=>{window.location.href="<?php echo base_url(); ?>Feeder_master_c"},200)
                   }else
                   {
