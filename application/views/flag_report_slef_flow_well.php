<div class="page-wrapper" style="    margin-top: -31px;">
<!-- Page Content -->
...
function get_well_list() { 
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>Flag_unflag_report_selfflow_c/Well_list',
