    ...
    <div class="content container-fluid">
    	<!-- Page Header -->
			<div class="page-header">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="page-title">Installation Report</h3>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo base_url('Dashboard_c');?>">Dashboard</a></li>
							<li class="breadcrumb-item ">Installation Report</li>
					...
					<div class="card">
                    	...
                    	<div class="card-body">
							<div class="row">
								...
								<div class="form-group col-md-4 mt-2">
									<h5><b>From Date</b></h5>
									<input type="date" name="from_date" id="from_date" class="form-control"  value="<?php echo date('Y-m-d'); ?>" onchange="get_installation_report();get_equipmentdate();">
								</div>

								<div class="form-group col-md-4 mt-2">
									<h5><b>To Date</b></h5>
									<input type="date" name="to_date" id="to_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" onchange="get_installation_report();get_equipmentdate();">
								</div>
                    ...
                    $('#table_data').html("");
                     if(response.data.length > 0)
                     {
                        $.each(response.data,function(i,v){
                        	...
                        	var sim_provider = v.sim_provider == 1 ? "Vi" : v.sim_provider == 2 ? "Airtel" : v.sim_provider == 3 ? "JIO"  : "";

                        	var network_type = v.network_type == 1 ? "2G" : v.network_type == 2 ? "3G" : v.network_type == 3 ? "4G" : "";
