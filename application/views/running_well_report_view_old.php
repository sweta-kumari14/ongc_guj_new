                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
					            ...
					            <div class="col-auto float-end ms-auto">
                                    ...
                                    <a href="<?php echo base_url().'Dashboard_c/get_single_well_detail_dashboard/'.$this->uri->segment(3); ?>"><button type="button" class="btn btn-sm btn-primary mx-2">Back</button></a>
					            </div>
			                </div>
				...
				<div class="table-responsive">
					<table class="table table-bordered border-bottom" id="basic-datatable">
						<thead class="bg-light text-center">
							...
							<tr>
								<th colspan="6" class="text-uppercase" style="font-size: 15px;font-weight: bolder;"> Well &nbsp;(<span id="well_name"></span>) Running Report as on <?php echo date('d-m-Y h:i:s a') ?></th>
							</tr>
							<tr>
                    ...
                    Object.keys(groupedData).forEach(function(date) {
                        Object.keys(groupedData[date]).forEach(function(well) {
                            ...
                            var remainingMinutes = wellData.totalshutdown - wellData.totalRunningMinute;
                                ...
                                all_shutdown_sum += remainingMinutes;
