                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                    	<div class="col">
					                       <h4 class="header-title mb-4">Site List</h4>
					                    </div>
								        <div class="col-auto float-end ms-auto">
								             <a href="<?php echo base_url('Site_c/add_site_page'); ?>">
												...
												foreach ($site_list as $key => $value)
												{
													?>
														<tr>
															...
															<td>
									                          <a href="<?php echo base_url().'Site_c/edit_site/'.$value['id'];  ?>"><i class="fas fa-pencil-alt" style="font-size:20px;color:green;"></i>
									                          </a>
									                                                
									                          <a id="<?php echo $value['id']; ?>" onclick="delete_site(this.id);">
    ...
    function delete_site(id)
    {
      swal({
           ...
           if (willDelete) {
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo base_url(); ?>Site_c/delete_site',
                data:{id: id},
                success:function(res)
                {
                    ...
                    if(res.response_code==200)
                    {
                      ...
                      setTimeout(()=>{window.location.href="<?php echo base_url(); ?>Site_c"},200)
                   }else
                   {
