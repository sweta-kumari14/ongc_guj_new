...
function initMap() {
  ...
  $.ajax({
    url:'<?php echo base_url(); ?>Selfflow_c/get_site_location_for_new_tab',
    type : 'POST',
        ...
        var map = new google.maps.Map(document.getElementById('mymap'), {
          ...
          var infowindow = new google.maps.InfoWindow({
				  content: '<div class="site-info" style="width: 100px; height: 100px;">' +
				            ...
				            ((marker.status == null )
				              ? ''
				              : '<a target="_blank" href="<?php echo base_url(); ?>Selfflow_c/get_single_well_detail_dashboard/' + marker.well_id + '">View Details</a>'
